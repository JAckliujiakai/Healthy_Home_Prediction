# -*- coding: utf-8 -*-
"""Healthy Home Prediction Project .ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1MeN6PxqeHQmqAXiS_mw2or5bHdKKLEA2
...
# ****
!cd /content/drive/MyDrive/Colab_Notebooks/projects/data/

# Read air pollutant & health info
df_1 = pd.read_csv("/content/drive/MyDrive/Colab_Notebooks/projects/data/Home_n_Map.csv")
df_1.head(5)
...
# (2) Choose a method of handling the missing data - drop all N/A
...
print(oakland_rds.columns)

sns.countplot(data=oakland_rds, x='highway')
...
# Drop features
gpd_1_city = gpd_1_city.drop(['zone'], axis=1)

"""### health conversion"""

# if df['Respiratory_HI'] contains 'high', replace "high" to "3" and save into df['Respiratory_HI']
gpd_1_city['Respiratory_HI'] = gpd_1_city['Respiratory_HI'].astype(str)
...
filtered_df = df_vis[df_vis['road_type'] == 'desired_value']
sns.countplot(x = 'road_type', data = filtered_df);
...
"""看positive or negatibe of factors: SHAP value
